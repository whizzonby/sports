 ...
 * */
function MenuEditor(idSelector, options, customOptions) {
    var $main = $("#" + idSelector).data("level", "0");
    var settings = {
        labelEdit: '<i class="fas fa-edit clickable"></i>',
        labelRemove: '<i class="fa-solid fa-trash"></i>',
        textConfirmDelete: customOptions.textConfirmDelete || 'Are you sure you want to delete this item?',
        textConfirmDeleteTitle: customOptions.textConfirmDeleteTitle || 'Confirm Delete',
        confirmButtonText: customOptions.confirmButtonText || 'Yes, delete it!',
        cancelButtonText: customOptions.cancelButtonText || 'No, cancel!',
        ...
        listOptions: { 
            ...
            opener: {
                ...
                openerCss: {},
                openerClass: ' opener-class',
            },
            placeholderCss: {'background-color': '#EFEBFF'},
    ...
    $main.on('click', '.btnRemove', function (e) {
        ...
        Swal.fire({
            ...
            text: settings.textConfirmDeleteTitle,
            icon: 'warning',
    ...
    function TButtonGroup() {
        var $divbtn = $('<div>').addClass('btn-group menu-editor-btn');
        var $btnEdit = TButton({classCss: 'btn btn-icon btn-label-primary btn-sm btnEdit', text: settings.labelEdit});
        var $btnRemv = TButton({classCss: 'btn btn-icon btn-label-danger btn-sm btnRemove', text: settings.labelRemove});
        var $btnUp = TButton({classCss: 'btn btn-icon btn-label-secondary btn-sm btnUp btnMove', text: '<i class="fas fa-angle-up clickable"></i>'});
        var $btnDown = TButton({classCss: 'btn btn-icon btn-label-secondary btn-sm btnDown btnMove', text: '<i class="fas fa-angle-down clickable"></i>'});
        var $btnOut = TButton({classCss: 'btn btn-icon btn-label-secondary btn-sm btnOut btnMove', text: '<i class="fas fa-level-down-alt clickable"></i>'});
        var $btnIn = TButton({classCss: 'btn btn-icon btn-label-secondary btn-sm btnIn btnMove', text: '<i class="fas fa-level-up-alt clickable"></i>'});
    ...
    this.add = function(){
        ...
        var div = $('<div>').append(textItem).append(btnGroup);
        var $li = $("<li>").data(data);
