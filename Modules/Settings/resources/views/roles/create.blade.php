...
<form action="{{ route('admin.roles.store') }}" method="POST">
    @csrf
    @method('POST')
    <x-card :heading="__('admin.create_role')" :route="route('admin.roles.index')" btnType="back">
        ...
        <div class="mt-6 border-bottom"></div>
                            ...
                            <div class="row row-cols-1 g-2 ps-7">
                                ...
                                <div class="col">
                                    <div class="form-check mb-0">
                                        <input type="checkbox" name="permissions[]" value="{{ $permission->name }}" class="form-check-input permission-input me-2" id="permission-{{ $permission->id }}">
