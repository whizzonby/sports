            ...
            <tbody>
                @php
                    $variables = [
                        ...
                        '{{subtotal}}' => __('admin.subtotal'),
                        '{{discount}}' => __('admin.discount'),
                        '{{tax}}' => __('admin.tax'),
                        '{{shipping_charge}}' => __('admin.shipping_charge'),
                        '{{total_amount}}' => __('admin.total_amount'),
                        '{{payment_method}}' => __('admin.payment_method'),
                        '{{payment_status}}' => __('admin.payment_status'),
                        '{{order_status}}' => __('admin.order_status'),
                        '{{order_date}}' => __('admin.order_date'),
                        '{{order_detail}}' => __('admin.order_detail'),
