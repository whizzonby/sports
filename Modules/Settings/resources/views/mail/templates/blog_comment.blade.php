...
<x-card>
    <form action="{{ route('admin.update.mail_template', ['id' => $template->id]) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <textarea id="message" name="message" class="form-control tinymce" rows="10">{!! clean($template->message) !!}</textarea>
