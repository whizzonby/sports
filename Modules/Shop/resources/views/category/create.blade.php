...
@section('title', __('admin.add_product_category'))
...
@include('core::layout.partials.breadcrumb', [
    ...
    'breadcrumbs' => [
        ...
        ['label' => __('admin.add_product_category')]
    ]
])
@endsection
...
<form action="{{ route('admin.product-category.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('POST')
    <x-card :heading="__('admin.add_product_category')" :route="route('admin.product-category.index')" btnType="back">
