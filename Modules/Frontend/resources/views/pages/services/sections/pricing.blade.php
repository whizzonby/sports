...
@section('title', __('section.services_page_pricing_section'))
...
@include('core::layout.partials.breadcrumb', [
    ...
    'breadcrumbs' => [
        ...
        ['label' => __('section.services_page_pricing_section')]
    ]
])
@endsection
...
<div class="pb-12">
    <form action="{{ route('admin.services_page.update_pricing_section', ['section_id' => $section->id, 'code' => $code]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <x-card :heading="__('section.services_page_pricing_section')" :route="route('admin.services_page.index')" btnType="back">
            <div class="row gy-5">
