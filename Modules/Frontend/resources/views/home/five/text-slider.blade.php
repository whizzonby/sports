...
@section('title', __('section.home_five_text_slider_section'))
...
@include('core::layout.partials.breadcrumb', [
    ...
    'breadcrumbs' => [
        ...
        ['label' => __('section.home_five_text_slider_section')]
    ]
])
@endsection
...
<div class="pb-12">
    <form action="{{ route('admin.home_five.update_section', ['slug' => $section->slug, 'code' => $code]) }}" method="POST" enctype="multipart/form-data">
        ...
        <x-card :heading="__('section.home_five_text_slider_section')" :route="route('admin.home_five.index')" btnType="back">
