...
@include('core::layout.partials.breadcrumb', [
    ...
    'breadcrumbs' => [
        ...
        ['label' => __('admin.home_six_sections')],
    ]
])
@endsection
            ...
            <div class="card mb-5 shadow rounded-md ">
                <div class="card-header bg-white py-4 d-flex align-items-center flex-wrap gap-8">
                    ...
                    <div class="ms-auto d-flex gap-2">
                        <a href="{{ route('admin.home_six.section', ['slug' => $section->slug, 'code' => getDefaultLocale()]) }}" class="btn btn-sm btn-icon btn-label-primary gap-2 d-inline-flex align-items-center">
