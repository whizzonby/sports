...
@section('title', __('section.home_six_banner_section'))
...
@include('core::layout.partials.breadcrumb', [
    ...
    'breadcrumbs' => [
        ...
        ['label' => __('section.home_six_banner_section')]
    ]
])
@endsection
...
<div class="pb-12">
    <form action="{{ route('admin.home_six.update_section', ['slug' => $section->slug, 'code' => $code]) }}" method="POST" enctype="multipart/form-data">
        ...
        <x-card :heading="__('section.home_six_banner_section')" :route="route('admin.home_six.index')" btnType="back">
