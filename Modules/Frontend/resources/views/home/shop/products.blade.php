...
@section('title', __('section.home_shop_products_section'))
...
@include('core::layout.partials.breadcrumb', [
    ...
    'breadcrumbs' => [
        ...
        ['label' => __('section.home_shop_products_section')]
    ]
])
@endsection
...
<div class="pb-12">
    <form action="{{ route('admin.home_shop.update_products_section', ['section_id' => $section->id, 'code' => $code]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <x-card :heading="__('section.home_shop_products_section')" :route="route('admin.home_shop.index')" btnType="back">
            <div class="row gy-5">
