...
@section('title', __('section.home_two_faq_section'))
...
@include('core::layout.partials.breadcrumb', [
    ...
    'breadcrumbs' => [
        ...
        ['label' => __('section.home_two_faq_section')]
    ]
])
@endsection
...
<div class="pb-12">
    <form action="{{ route('admin.home_two.update_faq_section', ['section_id' => $section->id, 'code' => $code]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <x-card :heading="__('section.home_two_faq_section')" :route="route('admin.home_two.index')" btnType="back">
            <div class="row gy-5">
