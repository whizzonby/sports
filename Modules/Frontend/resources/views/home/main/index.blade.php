...
@include('core::layout.partials.breadcrumb', [
    'title' => __('section.main_home_sections'),
    'breadcrumbs' => [
        ['label' => __('admin.dashboard'), 'url' => route('admin.dashboard')],
        ['label' => __('admin.home_main_sections')],
    ]
])
@endsection
            ...
            <div class="card mb-5 shadow rounded-md ">
                <div class="card-header bg-white py-4 d-flex align-items-center flex-wrap gap-8">
                    ...
                    <div class="ms-auto d-flex gap-2">
                        <a href="{{ route('admin.home_main.section', ['slug' => $section->slug, 'code' => getDefaultLocale()]) }}" class="btn btn-sm btn-icon btn-label-primary gap-2 d-inline-flex align-items-center">
