...
@section('title', __('section.home_main_text_slider_section'))
...
@include('core::layout.partials.breadcrumb', [
    ...
    'breadcrumbs' => [
        ...
        ['label' => __('section.home_main_text_slider_section')]
    ]
])
@endsection
@section('content')
...
<div class="pb-12">
    <form action="{{ route('admin.home_main.update_text_slider_section', ['slug' => $section->slug, 'code' => $code]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <x-card :heading="__('section.home_main_text_slider_section')" :route="route('admin.home_main.index')" btnType="back">
