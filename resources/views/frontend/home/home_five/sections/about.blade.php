                            ...
                            <div class="row">
                                <div class="col-xl-3">
                                    <div class="tp-about-title-box">
                                        <span class="tp-section-subtitle pre tp_fade_anim">{!! clean(pureText($content?->subtitle)) !!}</span>
                                    </div>
                                </div>
                                <div class="col-xl-9">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-5 col-lg-4 col-md-5">
                                                <div class="tp-about-thumb">
                                                    <img data-speed=".8" src="{{ asset($default_content?->main_image) }}" alt="{{ $content?->title }}">
                                                </div>
                                            </div>
