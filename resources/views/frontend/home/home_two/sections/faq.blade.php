...
<div class="app-faq-area p-relative pb-120">
    <div class="it-faq-shape-1">
        <img data-speed=".9" src="{{ asset($default_content?->shape) }}" alt="{{ $content?->title }}">
    </div>
    <div class="container container-1230">
        <div class="row">
            <div class="col-lg-4">
                <div class="app-faq-heading p-relative mb-40">
                    <span class="tp-section-subtitle border-bg bg-color">
                    ...
                    <img data-speed="1.1" class="it-faq-shape-2" src="{{ asset($default_content?->image) }}" alt="{{ $content?->title }}">
                </div>
            </div>
