...
@section('meta_title', $seo_setting['faq']['seo_title'])
@section('meta_description', $seo_setting['faq']['seo_description'])
@section('meta_keywords', $seo_setting['faq']['seo_keywords'])
                ...
                <div class="col-xl-12">
                    <div class="ar-hero-title-box tp_fade_anim" data-delay=".3">
                        ...
                        <h3 class="tp-career-title pb-30 insert-breadcrumb-shape">
                            {!! clean(pureText(__('frontend.frequently_asked_question'))) !!}
                        </h3>
                    </div>
                </div>
            </div>
