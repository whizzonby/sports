            ...
            <div class="col-xxl-12">
                <div class="breadcrumb__content p-relative z-index-1">
                    <div class="breadcrumb__list has-icon">
                        ...
                        <span><a href="{{ route('home') }}">{{ __('frontend.home') }}</a></span>
                        <span><a href="{{ route('products') }}">{{ __('frontend.products') }}</a></span>
                        <span><a href="{{ route('products', ['category' => $category->id]) }}">{{ $category->title }}</a></span>
                        <span>{{ $title }}</span>
                    </div>
                </div>
            </div>
